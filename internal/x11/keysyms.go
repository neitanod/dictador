// Code generated from /usr/include/X11/keysymdef.h and XF86keysym.h. DO NOT EDIT.

package x11

// keysymByName traduce el nombre simbólico de una tecla ("Control_R",
// "ISO_Level3_Shift") al keysym que X usa para identificarla.
//
// Esta tabla es el equivalente de los grupos que python-xlib carga a mano
// (miscellany, xkb, latin1, xf86, publishing, technical): sin ella
// "ISO_Level3_Shift" —que es AltGr— no se puede nombrar.
